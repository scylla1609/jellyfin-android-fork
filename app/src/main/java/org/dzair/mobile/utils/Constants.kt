package org.dzair.mobile.utils
...
object Constants {
    ...
    const val FRAGMENT_CONNECT_EXTRA_ERROR = "org.dzair.mobile.intent.extra.ERROR"
    const val FRAGMENT_WEB_VIEW_EXTRA_SERVER = "org.dzair.mobile.intent.extra.SERVER"
    ...
    const val MEDIA_NOTIFICATION_CHANNEL_ID = "org.dzair.mobile.media.NOW_PLAYING"
    const val DOWNLOAD_NOTIFICATION_CHANNEL_ID = "org.dzair.mobile.download.DOWNLOAD_PROGRESS"
    ...
    const val ACTION_SHOW_PLAYER = "org.dzair.mobile.intent.action.SHOW_PLAYER"
    const val ACTION_PLAY = "org.dzair.mobile.intent.action.PLAY"
    const val ACTION_PAUSE = "org.dzair.mobile.intent.action.PAUSE"
    const val ACTION_REWIND = "org.dzair.mobile.intent.action.REWIND"
    const val ACTION_FAST_FORWARD = "org.dzair.mobile.intent.action.FAST_FORWARD"
    const val ACTION_PREVIOUS = "org.dzair.mobile.intent.action.PREVIOUS"
    const val ACTION_NEXT = "org.dzair.mobile.intent.action.NEXT"
    const val ACTION_STOP = "org.dzair.mobile.intent.action.STOP"
    const val ACTION_REPORT = "org.dzair.mobile.intent.action.REPORT"
    ...
    const val EXTRA_MEDIA_PLAY_OPTIONS = "org.dzair.mobile.MEDIA_PLAY_OPTIONS"
